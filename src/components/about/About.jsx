            ...
            <div className="wrapper">
                ...
                <ul>
                    ...
                    <li>I volunteer for <strong>Code for Australia</strong>, if you would like to join me (code, design, project management, creativity, etc) - don't hesitate to reach out => <a 
                        ...
                        rel="noreferrer"
                        title="Link to Code for Australia"
                    >
                    ...
                    <li>Lived and worked in 4 countries, speak Russian, Italian and a bit of Hindi & Chinese. It made a lot of sense to learn some programming ones as well :-) </li>
                    <li>Love animals, coffee, Jack London (when Netflix is off) and <strong>connecting with people</strong>.
                    </li>
                </ul>
