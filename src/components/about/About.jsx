        ...
        <div className="About" id="about">
            <div className="wrapper">
                ...
                <ul>
                    ...
                    <li>I volunteer for <strong>Inco web-app project</strong>, learning to work in a big team and my contribution is => <a 
                    ...
                    <li>I have a <strong>master degree in economics</strong> and a few other degrees/courses (more info => <a 
                    ...
                    <li>Lived and worked/studied in 4 countries, speak Russian, Italian and a bit of Hindi & Chinese. </li>
                    <li>Love animals, coffee and <strong>connecting with people</strong>.
                    </li>
                </ul>
